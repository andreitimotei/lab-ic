...
public class Ranges implements Iterable<Interval> {
  ...
  private void replaceOverlappingInterval(ListIterator<Interval> iter, Interval lowerPart) {
    addIfNotEmpty(iter, lowerPart);
  }

  private void addIfNotEmpty(ListIterator<Interval> iter, Interval lowerPart) {
